      ...
      <div className="relative z-10 h-full flex items-center">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl lg:max-w-3xl text-white">
            ...
            <button  
                className="group relative inline-flex items-center justify-center overflow-hidden rounded-xl px-8 py-4  text-white shadow-2xl transition-all duration-500 hover:shadow-emerald-500/30 bg-green-700 md:px-10 md:py-5 md:text-xl"
  onClick={() => {
