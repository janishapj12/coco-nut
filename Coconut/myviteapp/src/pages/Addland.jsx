...
const Addland = () => {
  ...
  const downloadReport = () => {
    ...
    const content = `
      Land Size: ${land.Landsize} perches
      Coconut Type: ${land.Coconuttype}
      Estimated Trees: ${result.estimatedTrees}
      Tree Spacing Area: ${result.treeSpacingArea} m²
    `;
    ...
    link.href = url;
    link.download = "land_estimation_report.txt";
    link.click();
        ...
        <Layout>
          <div className="flex min-h-screen items-center justify-center">
            <div className="w-full max-w-md p-6 space-y-6 bg-white shadow-md rounded-lg">
              <h2 className="text-center text-2xl font-bold">Land Manage</h2>
              ...
              {result && (
                <>
                  ...
                  <button
                    ...
                    className="mt-4 w-full bg-green-700 hover:bg-green-800 text-white p-2 rounded-md"
                  >
                    Download Report
                  </button>
                </>
              ...
              <p className="text-center text-sm">
                Already A Farmer? <Link to="/addfert" className="text-green-800">Fertiliser management</Link>
              </p>
            </div>
          </div>
        </Layout>
